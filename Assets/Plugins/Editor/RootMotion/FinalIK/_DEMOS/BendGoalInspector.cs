...
namespace RootMotion.Demos {
	...
	public class BendGoalInspector : Editor {
		...
		void OnSceneGUI() {
			...
			Handles.SphereHandleCap(0, script.transform.position, Quaternion.identity, 0.05f, EventType.Repaint);
			Handles.SphereHandleCap(0, bonePosition, Quaternion.identity, 0.025f, EventType.Repaint);
