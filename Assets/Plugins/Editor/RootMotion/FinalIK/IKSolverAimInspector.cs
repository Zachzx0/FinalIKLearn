...
using System;
	...
	public class IKSolverAimInspector: IKSolverInspector {
		...
		public static void AddScene(IKSolverAim solver, Color color, bool modifiable) {
			...
			if (solver.axis != Vector3.zero) Handles.ConeHandleCap(0, solver.transform.position, Quaternion.LookRotation(solver.transform.rotation * solver.axis), GetHandleSize(solver.transform.position) * 2f, EventType.Repaint);
